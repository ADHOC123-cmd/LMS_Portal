        ...
        <div className="max-w-md w-full">
          <div className="bg-surface-container-lowest rounded-[2rem] p-8 border border-red-500/20 shadow-2xl text-center">
            ...
            <div className="space-y-3">
              <a 
                href={`mailto:daniel@adhocnetwork.tech?subject=Device Access Reset Request&body=Hi Support,%0D%0A%0D%0AI would like to request a reset of my registered device for account: ${email}`}
